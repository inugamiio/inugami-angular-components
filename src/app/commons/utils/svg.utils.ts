...
import { CircleOption, RectOption, SvgAnimationCallback, SvgAnimationOption, SvgAnimationParameters, SvgOptionalOption, TextOption } from "../models/svg-options.model";
import { SvgTransform, SvgBuilder, SvgMath, SvgStyleGenerators, SvgAnimations } from "../models/svg-service.model";
import { Size, Vector, TransformationInfo, Dimension, Position, SvgStyle } from "../models/svg.models";
